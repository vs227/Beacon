...
const SECTIONS_DATA = [
  {
    ...
    desc: 'Powering enterprise AI with high-performance distributed vector indices. We bridge massive multi-modal knowledge graphs with sub-millisecond semantic retrieval, offering a rock-solid physical-grade backbone for complex RAG pipelines.',
  },
  {
    id: 'portal',
    tag: '01. Data Synthesis',
    tagColor: '#52A88B',
    title: 'Dynamic Hybrid Index Arrays.',
    desc: 'Synchronize structured databases and unstructured text clusters in real-time. Our unified retrieval gateway realigns enterprise data chunks dynamically, delivering high-density contexts to your LLM query interface.',
  },
  {
    id: 'entry',
    ...
    desc: 'Streamline data ingestion from raw files to live vector spaces. Our pipeline parses, segments, and embeds raw files on the fly, auto-optimizing overlap ratios to preserve semantic context across documents.',
  },
  {
    id: 'beyond',
    ...
    desc: "Unlock context-aware production-grade generation. Beacon's secure neural lattice validates context retrieval on every step, delivering verified ground-truth knowledge with 99.9% citation accuracy.",
    showCta: true,
  },
]
